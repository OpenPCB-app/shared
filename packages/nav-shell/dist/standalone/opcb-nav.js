...
`;var d='<svg class="logo" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="3" stroke="currentColor" stroke-width="2"/><line x1="8" y1="8" x2="16" y2="16" stroke="currentColor" stroke-width="1.5"/><circle cx="8" cy="8" r="1.5" fill="currentColor"/><circle cx="16" cy="8" r="1.5" fill="currentColor"/><circle cx="8" cy="16" r="1.5" fill="currentColor"/><circle cx="16" cy="16" r="1.5" fill="currentColor"/></svg>',y='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 .5A11.5 11.5 0 0 0 .5 12a11.5 11.5 0 0 0 7.86 10.92c.58.1.79-.25.79-.56v-2c-3.2.7-3.88-1.37-3.88-1.37-.53-1.34-1.3-1.7-1.3-1.7-1.06-.72.08-.71.08-.71 1.17.08 1.79 1.2 1.79 1.2 1.04 1.79 2.73 1.27 3.4.97.1-.76.41-1.27.74-1.56-2.55-.29-5.23-1.28-5.23-5.68 0-1.25.45-2.28 1.19-3.08-.12-.29-.52-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11 11 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.59.23 2.76.11 3.05.74.8 1.19 1.83 1.19 3.08 0 4.41-2.69 5.38-5.25 5.67.42.36.8 1.08.8 2.18v3.23c0 .31.21.67.8.56A11.5 11.5 0 0 0 23.5 12 11.5 11.5 0 0 0 12 .5z"/></svg>',p='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z"/></svg>',g='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="4.2"/><path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5 5l1.5 1.5M17.5 17.5L19 19M19 5l-1.5 1.5M6.5 17.5L5 19"/></svg>',k='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',m='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18"/></svg>',z='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>',M='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';var C=["opcb-theme","openpcb.cloud.theme"];function Q(){let r=location.hostname;return r==="openpcb.app"||r.endsWith(".openpcb.app")}function B(){let r=location.protocol==="https:"?"; Secure":"",a=Q()?"; Domain=.openpcb.app":"";return`; Path=/; SameSite=Lax${r}${a}`}function $(r){let a=r.replace(/([.$?*|{}()[\]\\/+^])/g,"\\$1"),t=document.cookie.match(new RegExp("(?:^|; )"+a+"=([^;]*)"))?.[1];return t!=null?decodeURIComponent(t):null}function J(r,a,o=365){let t=Math.round(o*86400);document.cookie=`${r}=${encodeURIComponent(a)}; Max-Age=${t}${B()}`}function X(r){document.cookie=`${r}=; Max-Age=0${B()}`}function n(){let r=$("opcb_theme");if(r==="dark"||r==="light")return r;for(let t of C)try{let i=localStorage.getItem(t);if(i==="dark"||i==="light")return i}catch{}let a=document.documentElement;if(a.classList.contains("dark"))return"dark";let o=a.getAttribute("data-theme");if(o==="dark"||o==="light")return o;return"dark"}function e(r){let a=document.documentElement;a.setAttribute("data-theme",r),a.classList.toggle("dark",r==="dark")}function h(r){J("opcb_theme",r);for(let a of C)try{localStorage.setItem(a,r)}catch{}}function c(){let r=$("opcb_session");if(!r)return null;try{let a=JSON.parse(r);if(a&&typeof a.initials==="string"&&a.initials.length>0)return{name:typeof a.name==="string"?a.name:"",initials:a.initials.slice(0,2).toUpperCase()}}catch{}return null}function q(r){let a=(r.name??"").trim(),o={name:a,initials:H(a||r.email||"")};J("opcb_session",JSON.stringify(o))}function I(){X("opcb_session")}function H(r){let a=(r||"").trim();if(!a)return"·";let t=(a.includes("@")?a.split("@")[0]??a:a).split(/[\s._-]+/).filter(Boolean);if(t.length===0)return"·";if(t.length===1)return(t[0]??"").slice(0,2).toUpperCase()||"·";let i=t[0]??"",l=t[t.length-1]??"";return((i[0]??"")+(l[0]??"")).toUpperCase()||"·"}var K="https://openpcb.app",W="https://app.openpcb.app",Z=[{key:"features",label:"Product",area:"marketing",path:"/#features"},{key:"community",label:"Community",area:"app",path:"/"},{key:"roadmap",label:"Roadmap",area:"marketing",path:"/#roadmap"},{key:"compare",label:"Compare",area:"marketing",path:"/#compare"}];class f extends HTMLElement{static get observedAttributes(){return["mode","active","marketing-base","app-base"]}root;menuOpen=!1;lastSessionKey="";onFocus=()=>this.syncDynamic();constructor(){super();this.root=this.attachShadow({mode:"open"})}connectedCallback(){e(n()),this.render(),this.root.addEventListener("click",this.handleClick),this.root.addEventListener("submit",this.handleSubmit),window.addEventListener("focus",this.onFocus),document.addEventListener("visibilitychange",this.onFocus)}disconnectedCallback(){window.removeEventListener("focus",this.onFocus),document.removeEventListener("visibilitychange",this.onFocus)}attributeChangedCallback(){if(this.isConnected)this.render()}get navMode(){let r=this.getAttribute("mode");return r==="community"||r==="workspace"?r:"marketing"}get activeKey(){return this.getAttribute("active")??""}get marketingBase(){return(this.getAttribute("marketing-base")??K).replace(/\/$/,"")}get appBase(){return(this.getAttribute("app-base")??W).replace(/\/$/,"")}url(r,a){return(r==="marketing"?this.marketingBase:this.appBase)+(a.startsWith("/")?a:"/"+a)}render(){let r=c();this.lastSessionKey=r?r.initials+"|"+r.name:"";let a=this.navMode!=="marketing";this.root.innerHTML=`<style>${w}</style>
<header class="nav">
  <div class="wrap nav-row">
    ...
    <div class="nav-right">
      ...
      <button class="icon-btn" type="button" data-theme-toggle aria-label="Toggle theme" title="Toggle theme">${n()==="light"?g:p}</button>
      ${this.ctaHtml(r)}
  ...
  <div class="menu${this.menuOpen?" open":""}">
    ...
    </span>`}handleClick=(r)=>{let o=r.target?.closest("a,button");if(!o)return;if(o.matches("[data-theme-toggle]")){r.preventDefault(),this.toggleTheme();return}if(o.matches("[data-hamburger]")){r.preventDefault(),this.setMenu(!this.menuOpen);return}let t=o.getAttribute("href");if(!t)return;if(o.hasAttribute("data-app")&&this.navMode!=="marketing"){let i=new URL(t,location.href);if(i.origin===location.origin)r.preventDefault(),this.setMenu(!1),this.dispatchEvent(new CustomEvent("opcb-nav:navigate",{detail:{path:i.pathname+i.search+i.hash},bubbles:!0,composed:!0}))}};handleSubmit=(r)=>{let a=r.target;if(!(a instanceof HTMLFormElement)||!a.matches("[data-search]"))return;r.preventDefault();let t=a.querySelector("input[name=q]")?.value.trim()??"",i=this.navMode==="workspace"?"/app/library":"/",l=t?`${i}?q=${encodeURIComponent(t)}`:i,b=this.url("app",l);if(this.navMode!=="marketing"&&new URL(b,location.href).origin===location.origin)this.dispatchEvent(new CustomEvent("opcb-nav:navigate",{detail:{path:l},bubbles:!0,composed:!0}));else location.href=b};toggleTheme(){let r=n()==="dark"?"light":"dark";e(r),h(r);let a=this.root.querySelector("[data-theme-toggle]");if(a)a.innerHTML=r==="light"?g:p;this.dispatchEvent(new CustomEvent("opcb-nav:theme",{detail:{theme:r},bubbles:!0,composed:!0}))}setMenu(r){if(this.menuOpen===r)return;this.menuOpen=r;let a=this.root.querySelector(".menu");if(a)a.classList.toggle("open",r);let o=this.root.querySelector("[data-hamburger]");if(o)o.setAttribute("aria-expanded",String(r))}syncDynamic(){if(!this.isConnected)return;e(n());let r=this.root.querySelector("[data-theme-toggle]");if(r)r.innerHTML=n()==="light"?g:p;let a=c();if((a?a.initials+"|"+a.name:"")!==this.lastSessionKey)this.render()}}function Y(r){return r.replace(/[&<>]/g,(a)=>a==="&"?"&amp;":a==="<"?"&lt;":"&gt;")}function V(r){return r.replace(/["&<>]/g,(a)=>a==='"'?"&quot;":a==="&"?"&amp;":a==="<"?"&lt;":"&gt;")}var F="https://openpcb.app",N="https://app.openpcb.app",x="https://github.com/OpenPCB-app/OpenPCB";class v extends HTMLElement{static get observedAttributes(){return["marketing-base","app-base"]}root;constructor(){super();this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.root.addEventListener("click",this.handleClick)}attributeChangedCallback(){if(this.isConnected)this.render()}get marketingBase(){return(this.getAttribute("marketing-base")??F).replace(/\/$/,"")}get appBase(){return(this.getAttribute("app-base")??N).replace(/\/$/,"")}mk(r){return this.marketingBase+r}app(r){return this.appBase+r}render(){this.root.innerHTML=`<style>${_}</style>
<footer class="footer">
  <div class="wrap">
    <div class="foot-grid">
      ...
      <div class="foot-col">
        <h5>Resources</h5>
        <a href="${x}" target="_blank" rel="noopener noreferrer">GitHub</a>
        <a href="${x}/issues" target="_blank" rel="noopener noreferrer">Issues</a>
        <a href="${x}/blob/main/ROADMAP.md" target="_blank" rel="noopener noreferrer">Roadmap</a>
        <a href="${this.app("/sign-in")}" data-app>Sign in</a>
      </div>
      <div class="foot-col">
        <h5>License</h5>
        <a href="${x}/blob/main/LICENSE" target="_blank" rel="noopener noreferrer">AGPL-3.0</a>
        <a href="${this.mk("/#commercial")}">Commercial</a>
        <a href="${x}/security/policy" target="_blank" rel="noopener noreferrer">Security</a>
      </div>
    </div>
...
</footer>`}handleClick=(r)=>{let a=r.target?.closest("a");if(!a)return;let o=a.getAttribute("href");if(!o||!a.hasAttribute("data-app"))return;let t=new URL(o,location.href);if(t.origin===location.origin)r.preventDefault(),this.dispatchEvent(new CustomEvent("opcb-nav:navigate",{detail:{path:t.pathname+t.search+t.hash},bubbles:!0,composed:!0}))}}var G="https://app.openpcb.app";class s extends HTMLElement{static get observedAttributes(){return["active","app-base"]}root;constructor(){super();this.root=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.root.addEventListener("click",this.handleClick)}attributeChangedCallback(){if(this.isConnected)this.render()}get appBase(){return(this.getAttribute("app-base")??G).replace(/\/$/,"")}render(){let r=this.getAttribute("active")!=="workspace";this.root.innerHTML=`<style>${u}</style>
<div class="area-seg" role="tablist" aria-label="Zone">
  <a class="${r?"on":""}" href="${this.appBase}/" data-app role="tab" aria-selected="${r}">${m}Community</a>
  <a class="${!r?"on":""}" href="${this.appBase}/app" data-app role="tab" aria-selected="${!r}">${z}Workspace</a>
</div>`}handleClick=(r)=>{let a=r.target?.closest("a");if(!a)return;let o=a.getAttribute("href");if(!o)return;let t=new URL(o,location.href);if(t.origin===location.origin)r.preventDefault(),this.dispatchEvent(new CustomEvent("opcb-nav:navigate",{detail:{path:t.pathname+t.search+t.hash},bubbles:!0,composed:!0}))}}function U(){if(typeof customElements>"u")return;if(!customElements.get("opcb-nav"))customElements.define("opcb-nav",f);if(!customElements.get("opcb-footer"))customElements.define("opcb-footer",v);if(!customElements.get("opcb-zoneswitch"))customElements.define("opcb-zoneswitch",s)}U();export{q as setSessionHint,h as persistTheme,H as initialsOf,n as getTheme,c as getSession,U as defineOpcbShell,I as clearSessionHint,e as applyTheme,s as OpcbZoneSwitch,f as OpcbNav,v as OpcbFooter};
